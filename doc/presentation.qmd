...
## Are there significance in the log2 fold change for some genes?
...
::: {.r-stack}
![](images/07_forest_plot_p_value.png){.fragment}
![](images/07_volcano_plot_of_signifcantly_expressed_genes.png){.fragment}
