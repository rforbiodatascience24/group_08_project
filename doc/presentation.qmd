---
title: "Gene expression analysis of novel combination treatment for metastatic breast cancer"
author: |
...
We may also want to include the histogram over distribution of code_classes

::: r-stack
![](images/04_top_2_procent_fold_change.png){.fragment}
:::

## Analysis 1 results - find better title

![](images/05_plots_all_together.png){.absolute}
...
::::: r-stack
::: fragment
![](images/07_forest_plot_p_value.png)
:::

::: fragment
![](images/07_volcano_plot_of_signifcantly_expressed_genes.png)
:::
:::::
