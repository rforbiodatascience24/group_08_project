...
# Download the gzipped file to a local file
...
```{r}
# write to data folder
write_csv(x = post_data_GSM8152447,
          file = here("data/post_data_GSM8152447.csv"))
write_csv(x = post_data_GSM8152448,
          file = here("data/post_data_GSM8152448.csv"))
write_csv(x = post_data_GSM8152449,
          file = here("data/post_data_GSM8152449.csv"))
write_csv(x = post_data_GSM8152450,
          file = here("data/post_data_GSM8152450.csv"))
write_csv(x = post_data_GSM8152451,
          file = here("data/post_data_GSM8152451.csv"))
```
