...
# save plots
ggsave(here("results/density_plot_pre.png"), plot = density_plot_of_gene_classes, width = 10, height = 6)
ggsave(here("results/density_plot_post.png"), plot = density_plot_of_gene_classes, width = 10, height = 6)
```
