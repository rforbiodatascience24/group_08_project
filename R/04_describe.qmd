...
```{r}
#The 2% most upregulated and the 2% most downregulated for each class are plottet. Here you can see which genes are most up regulated and downregulated from each class. 
describe_dat_aug_03 |> 
  group_by(code_class) |> 
 mutate(
