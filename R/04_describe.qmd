...
# save plots
ggsave(here("results/04_density_plot_pre.png"), plot = density_gene_class_pre, width = 10, height = 6)
ggsave(here("results/04_density_plot_post.png"), plot = density_gene_class_post, width = 10, height = 6)
```
...
# save plot
ggsave(here("results/04_top_2_procent_fold_change.png"), plot = top2_procent_fold_change, width = 10, height = 6)
```
