...
# save plots
ggsave(here("results/density_plot_pre.png"), plot = density_gene_class_pre, width = 10, height = 6)
ggsave(here("results/density_plot_post.png"), plot = density_gene_class_post, width = 10, height = 6)
```
