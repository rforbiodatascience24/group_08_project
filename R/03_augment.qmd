...
df_pre <- replace_outliers_with_na(mbc_clean_aug, "pre_count")
df_post <- replace_outliers_with_na(mbc_clean_aug, "post_count")
  
joined_df <- df_pre |>
  inner_join(df_post, by = "gene")
...
### Log2 transform count values (not mean count values)
