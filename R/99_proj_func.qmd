...
# Filtering means for no outliers in pre and post data

```{r}
calculate_filtered_mean_pre <- function(data) {
  ...
  mean_filtered <- mean(filtered_data)
...
# Example usage
calculate_mean_without_outliers(data)
